        ...
        <Command
          filter={(value, search) => {
            ...
            if (option) {
                ...
                const normalizedSearchValue = option.searchValue?.trim().toLowerCase() || '';
                if (normalizedLabel.includes(normalizedSearch) || normalizedSearchValue.includes(normalizedSearch)) return 1;
            }
            return 0
          }}
        >
